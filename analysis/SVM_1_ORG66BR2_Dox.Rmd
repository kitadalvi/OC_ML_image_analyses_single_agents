...
write.csv(summary, here::here("output/summary_morphology_ORG66BR2.csv"))
```
...
write.csv(pred_all_data, here::here("output/pred_all_data_ORG66BR2.csv"))
...
write.csv(pred_all_data_mean, here::here("output/pred_all_data_mean_ORG66BR2.csv"))
```
