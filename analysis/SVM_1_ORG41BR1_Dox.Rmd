...
By randomising/scrambling the category labels, we create a data set that should not be predicted correctly and indeed, the prediction accuracy for the scrambled data drops down to 58%. 
...
**Here, changing cost from 1 to 10 and keep gamma at default improved the model performance from 97% to 99% accuracy.**
