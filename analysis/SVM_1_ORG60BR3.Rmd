...
The following Wells were excluded from Media and DMSO controls: NONE. <br>
...
**Here, changing cost from 1 to 7 and keep gamma at default improved the model performance from 94% to 99% accuracy.**
