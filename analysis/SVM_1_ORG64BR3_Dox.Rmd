---
title: "3D Image-based classification & SVM Analyses of ORG64BR3"
...
annotationsCTG <- read_csv(here::here("data/OC_ORG64_annotatedCTG.csv")) %>% dplyr::select(-WELL_ID)
...
```{r}
annotationsCTG <- read_csv(here::here("data/OC_ORG64_annotatedCTG.csv")) 
...
#write.csv(all_data_with_bins, here::here("output/all_data_with_bins.csv"))
...
#write.csv(all_data_clean, here::here("output/all_data_clean.csv"))

#write.csv(all_data_clean, here::here("output/Feature_reduced_raw_data.csv"))
```
...
#write.csv(data_all_short, "data_all_short.csv")
...
**Here, changing cost from 1 to 50 and keep gamma at default improved the model performance from 96% to 100% accuracy.**
...
write.csv(summary, here::here("output/summary_morphology_ORG64BR3.csv"))
```
...
write.csv(pred_all_data, here::here("output/pred_all_data_ORG64BR3.csv"))
...
write.csv(pred_all_data_mean, here::here("output/pred_all_data_mean_ORG64BR3.csv"))
```
