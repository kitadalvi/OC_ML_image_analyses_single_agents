...
The following Wells were excluded from Media and DMSO controls: N13, O13 and H13. <br>
...
norm_CTG <- annotationsCTG %>%
  ...
  filter(!Well_ID %in% c('N13','H13','O13')) %>% 
  group_by(Patient) %>% 
...
**Here, changing cost from 1 to 10 and keep gamma at default improved the model performance from 98% to 99% accuracy.**
