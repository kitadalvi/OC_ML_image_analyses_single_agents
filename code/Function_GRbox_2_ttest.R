...
GRbox <- function(fitData, metric, groupVariable, pointColor,
  ...
  if(plotly == TRUE) {
    ...
    p = p + ggplot2::geom_boxplot(ggplot2::aes_string(
      fill = groupVariable, alpha = 0.3), outlier.color = NA, show.legend = FALSE) +
      ggplot2::geom_jitter(width = 0.25, show.legend = FALSE, ggplot2::aes_string(colour = pointColor, show.legend = FALSE)) +
      ggplot2::xlab('') + ggplot2::ylab(metric) +
